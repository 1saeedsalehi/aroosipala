    ...
    <div className="text-black bg-gray-100 min-h-screen p-0">
      ...
      <div id="description" className="text-rtl text-2xl bg-white p-8 rounded-lg shadow-md mb-6 text-right item-container">
        ...
        <p>
          ...
          دوستداشتنی‌هامون،<br />
          بدین وسیله، با خوشحالی و شادی، شما رو به جشن ازدواج‌مون دعوت می‌کنیم.<br />
          این مهمونی تو یک کافه دلنشین تو شهر رشت برگزار میشه و قراره در کنار شما لحظه‌های شیرینی بسازیم به صرف میوه، شام، کیک و چای دلچسب شمال.<br />
          شما عزیزان ما هستید و حضورتون این روز رو برای ما ارزشمندتر می‌کنه.<br />
          با همه‌ی شوقی که توی دل‌مون داریم، منتظرتون هستیم تا ما رو در این لحظات خوشبخت همراهی کنید.<br />
          با آرزوی دیدار روی ماهتون،<br />
          هانیه و سعید❤️
